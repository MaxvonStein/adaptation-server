...
var AWSS3Uploader = /** @class */ (function () {
  function AWSS3Uploader(config) {
    ...
    // got rid of aws_sdk_1["default"]
    aws_sdk_1.config = new aws_sdk_1.Config();
  ...
  AWSS3Uploader.prototype.createDestinationFilePath = function (
    fileName,
    mimetype,
    encoding
  ) {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            // added .prototype
            filePath = this.prototype.createDestinationFilePath(
              filename,
              mimetype,
              encoding
            );
            uploadStream = this.prototype.createUploadStream(filePath);
